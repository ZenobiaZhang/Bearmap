...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    double lon;
    double lat;
    ArrayList<GraphDB.Vertex> possibleV;
    boolean valid;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            GraphDB.Vertex newV = new GraphDB.Vertex(id, lon, lat);
            g.addVertext(newV.getId(), newV);
            ...
            GraphDB.Vertex vertex = g.getVertex(id);
            possibleV.add(vertex);
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            if (valid && !possibleV.isEmpty()) {

                for (int i = 0; i + 1 < possibleV.size(); i++) {
                    possibleV.get(i).addNeighborVertex(possibleV.get(i + 1));
                    possibleV.get(i + 1).addNeighborVertex(possibleV.get(i));
